...
def parse_args():
    ...
    parser.add_argument(
        "--images-dir",
        type=str,
        default='/common/users/$id/df_words',
        help="Path where the word images are saved"
    )
    parser.add_argument(
        "--project-dir",
        type=str,
        default='/common/home/$id/stylized-ocr',
...
def main():
    ...
    # Change to your desired directory
    os.chdir(args.project_dir) # change $USER to netid
    
    # Confirm it's changed
    print("Current directory:", os.getcwd())

    df_train_info= pd.read_csv("dataset_info/df_train_info.csv") 
    df_train_info.head()
