...
def parse_args():
    ...
    parser.add_argument(
        "--processor-dir",
        type=str,
        default="processors/train",
        help="Path to save processor for your database"
    )
    parser.add_argument(
        "--project-dir",
        type=str,
...
def main():
    ...
    # load images data
    import pickle
    with open('dataset/stylized/dfwords_0_20000.pkl', 'rb') as file:
        loaded_dfwords1 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_20000_40000.pkl', 'rb') as file:
        loaded_dfwords2 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_40000_60000.pkl', 'rb') as file:
        loaded_dfwords3 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_60000_80000.pkl', 'rb') as file:
        loaded_dfwords4 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_80000_100000.pkl', 'rb') as file:
        loaded_dfwords5 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_100000_120000.pkl', 'rb') as file:
        loaded_dfwords6 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_120000_140000.pkl', 'rb') as file:
        loaded_dfwords7 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_140000_160000.pkl', 'rb') as file:
        loaded_dfwords8 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_160000_180000.pkl', 'rb') as file:
        loaded_dfwords9 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_180000_200000.pkl', 'rb') as file:
        loaded_dfwords10 = pickle.load(file)
    
    with open('dataset/stylized/dfwords_200000_227055.pkl', 'rb') as file:
    ...
    df_train_info= pd.read_csv("dataset/stylized/df_train_info.csv") 
    df_train_info.head()
    ...
    # save processor
    processor.save_pretrained(args.processor_dir)
